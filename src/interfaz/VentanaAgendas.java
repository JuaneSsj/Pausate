...
public class VentanaAgendas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VentanaAgendas
     */
    ...
    private void btnAgendarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgendarActionPerformed
        ...
        for(int i=0;i<3;i++)
        {
            switch (i) {
                case 0 -> {
                    item=comboBoxModalidad.getSelectedIndex();
                    agendaPausa += comboBoxModalidad.getItemAt(item);
                    agendaPausa="\n";
                }
                case 1 -> {
                    item=comboBoxTipoPausa.getSelectedIndex();
                    agendaPausa += comboBoxTipoPausa.getItemAt(item);
                    agendaPausa="\n";
                }
                default -> {
                    item=comboBoxHora.getSelectedIndex();
                    agendaPausa += comboBoxHora.getItemAt(item);
                }
            }
        }
        agenda.llenar(agendaPausa);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAgendas().setVisible(true);
            }
        });
    }
